  ...
  <header class="bg-dark-900 border-b border-dark-700 px-6 py-4">
    <div class="flex items-center justify-between">
      ...
      <div class="flex-1 max-w-lg">
        <div class="relative">
          ...
          <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
            <kbd class="inline-flex items-center px-2 py-0.5 rounded text-xs font-mono text-gray-400 bg-dark-800 border border-dark-600">
              ⌘K
            </kbd>
          </div>
        </div>
      ...
      <div class="flex items-center space-x-4 ml-6">
        <!-- Notifications -->
        <button class="relative p-2 text-gray-400 hover:text-gray-300 transition-colors">
        ...
        <!-- AI Assistant -->
        <button class="p-2 text-gray-400 hover:text-neon-blue transition-colors" title="AI Assistant">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
