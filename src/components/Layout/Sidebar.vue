<template>
  <div class="fixed left-0 top-0 h-full w-64 bg-dark-900 border-r border-dark-700 flex flex-col">
    <!-- Logo -->
    ...
    <nav class="flex-1 p-4 space-y-2">
      <router-link
        ...
        :key="item.name"
        :to="item.path"
        class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-300 hover:text-white hover:bg-dark-800 transition-all duration-200"
        :class="{ 'bg-primary-600/20 text-primary-400 border border-primary-600/30': $route.path === item.path }"
      >
